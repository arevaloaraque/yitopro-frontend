...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div data-slot="table-container" className="relative w-full overflow-x-auto rounded-2xl border-[1.5px] border-clay-line shadow-clay">
      <table
        data-slot="table"
...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "border-t bg-surface/80 font-medium [&>tr]:last:border-b-0",
        className,
      )}
      {...props}
    />
