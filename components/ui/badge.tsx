...
const badgeVariants = cva(
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-all duration-150 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        default:
          "border-clay-line bg-primary text-primary-foreground [a]:hover:bg-primary/90",
        secondary:
          "border-clay-line/15 bg-secondary text-secondary-foreground [a]:hover:bg-secondary/80",
        destructive:
        ...
        success:
          "border-success/30 bg-success/10 text-success dark:bg-success/20 [a]:hover:bg-success/20",
        warning:
          "border-warning/40 bg-warning/15 text-warning-foreground dark:bg-warning/20 dark:text-warning [a]:hover:bg-warning/25",
        info: "border-info/30 bg-info/10 text-info dark:bg-info/20 [a]:hover:bg-info/20",
      },
    },
    defaultVariants: {
      variant: "default",
